    ...
    <div className="fixed top-0 left-0 bottom-0 z-50 w-22 h-full p-4 bg-background text-text-light flex flex-col justify-between">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <Icon
          icon={
            <img
              src="https://lh3.googleusercontent.com/ogw/AGvuzYb8Az9mueXWBCrZlm6FogE9a6D-WAWivPYEKrkB7g=s32-c-mo"
  ...
  return (
    <div className="center">
      <button
        ...
        className={`outline-none peer w-full aspect-square center rounded-[32px] border-2 transition border-transparent ${
          isActive
            ? "bg-primary rounded glow-primary"
            : "hover:rounded hover:border-secondary hover:bg-background-light"
        }`}
      >
        {icon}
      </button>
...
function SideSelector() {
  ...
  return (
    <div className="center">
      <select
        className="peer w-full group bg-background hover:bg-background-light border-transparent hover:border-secondary rounded-3xl hover:rounded
  ...
  return (
    <div className="center">
      <select
        className={`peer w-full group bg-background hover:bg-background-light border-transparent hover:border-secondary rounded-3xl hover:rounded
      border-2 h-10 transition outline-none text-center appearance-none ${
        isLoading ? "border-x-background-light rounded animate-pulse" : ""
      }`}
        onChange={(e) => {
      ...
      <Tooltip text={`Topic ${isLoading ? "- Loading" : ""}`} />
    </div>
  );
}
