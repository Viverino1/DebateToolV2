...
export default function SchoolSelector(props: {onChange: (school: string) => void, default?: string, disabled?: boolean}){
  ...
  return(
    <select className="input" defaultValue={props.default?? ""} disabled={props.disabled} onChange={(e) => props.onChange(e.target.value)}>
