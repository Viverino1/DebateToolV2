...
export default function CreateStatisticPage(props: {editCard?: Statistic}){
  ...
  const [card, setCard] = useState<Statistic>(props.editCard?? {
    type: "statistic",
    cardID: "",
    ownerUID: user.uid,
    school: user.school,
    ...
    <div className="relative w-full h-full flex">
      ...
      <div className="w-full md:w-1/2 lg:w-2/3 h-full p-4 flex flex-col space-y-4">
        <div className="flex flex-col space-y-4">
          ...
          type="text" 
          className="input !text-lg text-statistic" 
      ...
      <div className="relative hidden md:flex flex-col items-center justify-center md:w-1/2 lg:w-1/3 h-full p-4 pl-0">
        ...
        <div className="flex flex-col space-y-4 mt-4">
          ...
          />
          <button className="button-statistic !w-32 text-text-light" onClick={() => {
